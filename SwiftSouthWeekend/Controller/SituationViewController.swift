...
class SituationViewController: UIViewController {
    ...
    func getData() {
        let url = "http://www.infzm.com/mobile/get_list_by_cat_ids?cat_id%5B%5D=4718&" + String.init(format: "start=%i&count=%i", self.start, self.count) + "&platform=ireader&device=Unknown%20iPhone&version=5.1.0&system_version=9.3&hash=f2cdde51e779dd63b44690b9c86b216b&format=json"
        print("url---------:\(url)")
