...
class AbstractMediasCell: UICollectionViewCell {
    
    
    var modelItem: ModelItem! {
        didSet {
            print("abstract_medias-------:\(modelItem.short_subject)")
            let url1 = "http://images.infzm.com/medias/" + ( modelItem.abstract_medias?[0].replacingOccurrences(of: "\\", with: ""))!
            let url2 = "http://images.infzm.com/medias/" + ( modelItem.abstract_medias?[1].replacingOccurrences(of: "\\", with: ""))!
            let url3 = "http://images.infzm.com/medias/" + ( modelItem.abstract_medias?[2].replacingOccurrences(of: "\\", with: ""))!

            firstImageView.sd_setImage(with: URL(string: url1), placeholderImage: nil)
            secondImageView.sd_setImage(with: URL(string: url2), placeholderImage: nil)
            thirdImageView.sd_setImage(with: URL(string: url3), placeholderImage: nil)
    ...
    override init(frame: CGRect) {
        ...
        secondImageView.snp.makeConstraints { (make) -> Void in
